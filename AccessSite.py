...
class SiteActions(Thread) :
    ...
    def login_site (self):
        f = open('credentials.txt', 'r')             #retreive log in details from seperate txt file
        ...
        for part in self.parts_list:
            if (len(str(part))) < 5:
                ...
                try:
                    ...
                    f = open("file.html", "w")                                                               #temporary file to read html data from
                    ...
                    f.close()
                    try:
                        self.extract_info("file.html")                                                       #passing temporary html file to extract_info function to pull relevant data
    ...
    def write_to_excel (self, filename):
        ...
        df1.to_excel(str(filename))                                                             #Writes dataframe to excel sheet
